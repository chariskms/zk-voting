...
const nextConfig = {
   ...
   */
  basePath: process.env.NODE_ENV === 'production' ? '/zk-vote-project' : '', // update basePath if you change your repo name
  assetPrefix: process.env.NODE_ENV === 'production' ? '/zk-vote-project' : '' // update assetPrefix if you change your repo name. 
};
